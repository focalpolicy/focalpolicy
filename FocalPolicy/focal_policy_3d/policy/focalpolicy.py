...
class FocalPolicy(BasePolicy):
    def __init__(self, 
        ...
        cprint(f"[FocalPolicy] use_pc_color: {self.use_pc_color}", "yellow")
        cprint(f"[FocalPolicy] pointnet_type: {self.pointnet_type}", "yellow")
    ...
    def compute_loss(self, batch):
        ...
        #### sampling t and r
        t, r = sample_two_timesteps(self.sample_cfg, num_samples=target.shape[0], device=target.device, eps=eps)
